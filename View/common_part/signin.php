            ...
            <div class="col-lg-5 col-12" style="background-color: #051209 !important;">
                <div id="auth-left">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Bạn chưa có tài khoản? <a href="signup.php" class="font-bold text-success">Đăng Ký</a>.</p>
                        <p><a class="font-bold text-success" href="forgot-password.php">Quên Mật Khẩu?</a>.</p>
                    </div>
                </div>
            </div>
