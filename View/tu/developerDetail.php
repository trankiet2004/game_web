...
<img src="/game_web/View/data/<?= htmlspecialchars($developers['background_image']) ?>" alt="<?= htmlspecialchars($developers['name']) ?>" width="300">
...
document.getElementById("loadMoreBtn").addEventListener("click", function () {
    ...
    fetch("/game_web/index.php?action=load_more_games_in_developers", {
        method: "POST",
