...
<head>
    <meta charset="UTF-8">
    <base href="./View/tu/">
    <title><?= htmlspecialchars($tags['name']) ?> - Tag Details</title>
...
<body>
    ...
    <div class="tag-detail-container">
        <a class="back-link" href="../../index.php?action=tag">&larr; Back to Tag List</a>

        <h1><?= htmlspecialchars($tags['name']) ?></h1>
        <img src="../../View/data/<?= htmlspecialchars($tags['background_image']) ?>" alt="<?= htmlspecialchars($tags['name']) ?>" class="tag-img">
    ...
    <script>
        document.getElementById("loadMoreBtn")?.addEventListener("click", function () {
            ...
            fetch("../../index.php?action=load_more_games_in_tags", {
                method: "POST",
