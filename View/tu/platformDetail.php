...
<img src="/game_web/View/data/<?= htmlspecialchars($platform['background_image']) ?>" alt="<?= htmlspecialchars($platform['name']) ?>" width="300">
...
document.getElementById("loadMoreBtn").addEventListener("click", function () {
    ...
    fetch("/game_web/index.php?action=load_more_games", {
        method: "POST",
