...
} else if ($action === 'updateGenres' && $id !== null) {
    $selectedGenres = $_POST['genres'] ?? [];
    $gamecontroller->updateGenres($id, $selectedGenres);
} else if ($action === 'updatePlatforms' && $id !== null) {
    $selectedPlatforms = $_POST['platforms'] ?? [];
    $gamecontroller->updatePlatforms($id, $selectedPlatforms);
